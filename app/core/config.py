...
# Load .env file for local runtime
def load_env_file():
    """Load local .env file."""
...
class Settings:
    ...
    def __init__(self):
        ...
        self.DESCRIPTION = os.getenv(
            "DESCRIPTION", "A production-ready FastAPI template with LangGraph integration"
        )
        ...
        self.MYSQL_DB = os.getenv("MYSQL_DB", "agent_db")
        self.MYSQL_USER = os.getenv("MYSQL_USER", "root")
        self.MYSQL_PASSWORD = os.getenv("MYSQL_PASSWORD", "")
        self.MYSQL_POOL_SIZE = int(os.getenv("MYSQL_POOL_SIZE", "20"))
        self.MYSQL_MAX_OVERFLOW = int(os.getenv("MYSQL_MAX_OVERFLOW", "10"))
